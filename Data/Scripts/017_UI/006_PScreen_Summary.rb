...
class PokemonSummary_Scene
  ...
  def drawPageSix
    ...
    textpos = [
       ...
       [_INTL("Sp. Atk"),248,184,0,base,statshadows[PBStats::SPATK]],
       [sprintf("%d / %d",@pokemon.ev[4],@pokemon.iv[3]),456,184,1,Color.new(250,250,250),Color.new(30,30,30)],
       [_INTL("Sp. Def"),248,216,0,base,statshadows[PBStats::SPDEF]],
       [sprintf("%d / %d",@pokemon.ev[5],@pokemon.iv[4]),456,216,1,Color.new(250,250,250),Color.new(30,30,30)],
       [_INTL("Speed"),248,248,0,base,statshadows[PBStats::SPEED]],
       [sprintf("%d / %d",@pokemon.ev[3],@pokemon.iv[5]),456,248,1,Color.new(250,250,250),Color.new(30,30,30)],
       [_INTL("Ability"),224,284,0,base,shadow],
       [PBAbilities.getName(@pokemon.ability),362,284,0,Color.new(64,64,64),Color.new(176,176,176)],
    ]
    # Draw all text
